...
public static class DataTableExtension
{
    ...
    public static void LoadDataTable(this DataTableComponent dataTableComponent, string dataTableName, object userData = null)
    {
        ...
        // TODO LoadType要改成通用，而不是写死
        string dataTableNameInType = splitNames.Length > 1 ? splitNames[1] : null;
        dataTableComponent.LoadDataTable(dataRowType, dataTableName, dataTableNameInType, AssetUtility.GetDataTableAsset(dataTableName), LoadType.Bytes, Constant.AssetPriority.DataTableAsset, userData);
    }
